...
namespace PlataformaWeb.Recursos
{
    public class CambiarClave
    {
        ...
        public static DataTable Ejecutar(string nombreProcedimiento, List<ParametroClave> parametros = null)
        {
            ...
            try
            {
                ...
                if (parametros != null)
                {
                    foreach (var parametro in parametros)
                    {
                        ...
                        cmd.Parameters.AddWithValue(parametro.Nombre_Correo, parametro.Correo);
