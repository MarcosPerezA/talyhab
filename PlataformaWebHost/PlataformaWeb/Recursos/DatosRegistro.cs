...
namespace PlataformaWeb.Recursos
{
    public class DatosRegistro
    {
        ...
        public static DataTable Ejecutar(string nombreProcedimiento, List<ParametrosRegistro> parametros = null)
        {
            ...
            try
            {
                ...
                if (parametros != null)
                {
                    foreach (var parametro in parametros)
                    {
                        ...
                        cmd.Parameters.AddWithValue(parametro.Nombre_email, parametro.Email);
